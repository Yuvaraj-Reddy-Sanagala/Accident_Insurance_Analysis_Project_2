  ...
  return (
    <div className='page'>
      ...
      <div className='charts'>
          <h4> Pie Chart to analyze the percentage of insurance amount</h4>
          <label>Please select from the Dropdown below:</label>
          <Select 
      ...
      <div className='charts'>
          <h4> Pie Chart to analyze the avergae insurance amount by company</h4>
          <label>Please select from the Dropdown below:</label>
          <Select 
      ...
      <div className='charts'>
          <h4>  Pie Chart to analyze the avergae insurance amount by policy</h4>
          <label>Please select from the Dropdown below:</label>
          <Select 
